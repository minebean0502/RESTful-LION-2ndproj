...
import com.hppystay.hotelreservation.api.KNTO.service.KNTORepositoryService;
...
public class KNTORestClientConfig {
    @Bean
    public KNTORepositoryService kntoRestClient() {
        ...
        return factory.createClient(KNTORepositoryService.class);
    }
}
